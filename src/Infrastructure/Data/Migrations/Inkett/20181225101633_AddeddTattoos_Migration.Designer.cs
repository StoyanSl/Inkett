...
namespace Inkett.Infrastructure.Migrations.Inkett
{
    ...
    [Migration("20181225101633_AddeddTattoos_Migration")]
    partial class AddeddTattoos_Migration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inkett.ApplicationCore.Entitites.Tattoo.Tattoo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Inkett.ApplicationCore.Entitites.Tattoo.TattooStyle", b =>
                {
            ...
            modelBuilder.Entity("Inkett.ApplicationCore.Entitites.Tattoo.TattooStyle", b =>
                {
                    b.HasOne("Inkett.ApplicationCore.Entitites.Tattoo.Style", "Style")
                        .WithMany("TattooStyles")
                        .HasForeignKey("StyleId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Inkett.ApplicationCore.Entitites.Tattoo.Tattoo", "Tattoo")
                        .WithMany("TattooStyles")
